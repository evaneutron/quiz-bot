...
class Data:
    ...
    def add_player(self, user_id):
        ...
        players_file = open(self.players_file_name, 'a')
        players_file.write(str(user_id) + '\n')
